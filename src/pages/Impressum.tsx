      ...
      <main className="flex-grow pt-24 px-6">
        <div className="main-container">
          ...
          <div className="prose max-w-none">
            ...
            <p>CoinChat Explorer GmbH<br />
            Kryptostraße 123<br />
            10115 Berlin<br />
            Deutschland</p>
            
            <h2 className="text-xl font-semibold mt-8 mb-4">Kontakt</h2>
            <p>Telefon: +49 (0) 30 123456789<br />
            E-Mail: info@coinchat-explorer.com</p>
            
            <h2 className="text-xl font-semibold mt-8 mb-4">Vertretungsberechtigte Personen</h2>
            ...
            <p>Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://ec.europa.eu/consumers/odr/</a>.<br />
